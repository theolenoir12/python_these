...
def get_cost_ely(alpha_ely, P_ely):
    ...
    # factor_max = 1e4 * ELY['n_parallel'] * ELY['n_series'] / 50
    # P_ely_max = factor_max * (1.799 - 1.874 * alpha_ely)
    ...
    is_transient = delta_P > (0.05 * P_ely_max)
    ...
    return cost_financial, cost_start_stop, cost_maint, cost_steady, cost_shift
