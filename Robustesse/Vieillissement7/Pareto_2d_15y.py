...
points = np.array([
    [6.6997, 208.7457],   # 0-100
    [24.3189, 175.2456],  # 25-75
    [10.7333, 137.6821],  # 50-50
    [4.6102, 63.0629],    # 75-25
    [4.5393, 63.2961],    # 100-0
    [1.4320, 60.5127],    # RB2
    [1.6156, 39.9420],    # RB2(SoH)
    [1.7701, 92.6865],    # RB1
    [0.7954, 221.3859],   # SoC1
    [34.5915, 175.8923],  # SoC06
