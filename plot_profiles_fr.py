...
ax1.set_ylabel(r"Puissance [kW]", fontsize=16)
ax1.set_title("Profil de charge", fontsize=16)
...
ax2.set_xlabel(r"Jours", fontsize=16)
ax2.set_ylabel(r"Puissance [kW]", fontsize=16)
ax2.set_title("Profil de production PV", fontsize=16)
...
plt.savefig("sidelec_conso_PV_fr.pdf", bbox_inches='tight', pad_inches=0.02)
plt.show()